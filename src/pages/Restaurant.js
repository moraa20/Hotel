...
import '../Styles/RestaurantBooking.css';
...
const Restaurant = () => {
    ...
    const [bookingId, setBookingId] = useState(null); // For identifying the booking to be edited or canceled
    ...
    const handleCancelBooking = async (bookingId, bookingType) => {
        try {
            ...
            if (response.success) {
                ...
                // Optionally, update state or fetch updated bookings list
            } else {
